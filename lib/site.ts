...
export const siteConfig = {
  ...
  seo: {
    defaultTitle: "Durham Cleaners | Home Cleaning Durham Region",
    defaultDescription:
      "Professional residential, commercial, and industrial cleaning in Durham Region and the GTA. Courtice, Oshawa, Whitby, Ajax & Pickering. Call (416) 305-5187 or request service online.",
    keywords: [
      "Durham cleaners",
      ...
      "move out cleaning Ajax",
      "Airbnb cleaning Pickering",
  ...
  siteUrl: "https://www.durhamcleaners.ca",
  contact: {
    phone: "(416) 305-5187",
